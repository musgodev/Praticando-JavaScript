...
As aplicações consistem em um Conversor de Temperatura (Fahrenheit para Celsius), um Jogo da Adivinhação em que o usuário tenta adivinhar um número de 0 a 10, e uma Calculadora de Médias escolares.
